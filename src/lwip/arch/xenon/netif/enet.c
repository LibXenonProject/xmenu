...
{
	*(unsigned int*)(0x8000020000000000ULL|addr) = value;
}

static inline unsigned int read32(unsigned int addr)
{
	return *(unsigned int*)(0x8000020000000000ULL|addr);
}

static inline void write32mem(unsigned int addr, unsigned int value)
{
	*(unsigned int*)(0x8000000000000000ULL|addr) = value;
}

static inline unsigned int read32mem(unsigned int addr)
{
	return *(unsigned int*)(0x8000000000000000ULL|addr);
}
